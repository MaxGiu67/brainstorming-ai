---
name: bs-scope
description: "MVP Scoping: MoSCoW, anti-scope, milestone. Usa questa skill quando vuoi definire lo scope, prioritizzare feature, o dici bs scope, scope mvp, MoSCoW, anti-scope, cosa fare prima, priorità."
---
...
## Dopo lo scoping
Hai un perimetro MVP validato. Sai:
- **SE** l'idea regge (dal brainstorming)
- **COSA** costruire (dal problem framing + scoping)
